# This is copied.
# I had this exact intuition instantly (which is easy to implement) yet Leetcode marked the problem as hard, and I am 10 min. away before going to sleep.
# Seeing it's what I'd have done in that time, I am just copying it.
class Solution:
